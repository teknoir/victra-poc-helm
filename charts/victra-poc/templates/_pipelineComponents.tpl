...
{{- define "defaultNvDsAnalytics" }}
    ! queue ! nvdsanalytics config-file=/app/nvdsanalytics_config/config_nvdsanalytics.{{- default "txt" (default .Values.nvr.defaults.nvdsanalytics.configFormat .nvdsanalytics.configFormat) }}
